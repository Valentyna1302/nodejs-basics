...
// Тобто ресурс це обєкт, що зберігає інформацію про певну сутність.
const student = {
  id: 123,
  name: 'John Doe',
  age: 16,
...
// Основні методи запиту, які ми будемо використовувати:
...
// У REST API по URL можна точно встановити, яку інформацію ми можемо по ньому отримати. Наприклад:
// https://example.com/students - інформація про усіх студентів
// https://example.com/students/123 - інформація про конкретного студента за його id 123
// https://example.com/students/123/homeworks- інформація про усі домашні роботи студента з id 123

// Параметри запиту. У REST API це можна зробити за допомогою параметрів запиту (search params), які дозволяють фільтрувати або сортувати ресурси.
// <https://example.com/students?order=asc&search=joe&page=1&per_page=10>

GET <https://example.com/students> // Отримати інформацію про всіх студентів
PATCH <https://example.com/students/123> // Оновити інформацію про учня з id 123
DELETE <https://example.com/students/123/homeworks/456> // Видалити в учня з id 123 домашнє завдання з id 456
